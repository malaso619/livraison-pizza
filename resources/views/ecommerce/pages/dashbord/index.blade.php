...
@section('content')
        ...
        <div class="main-panel">
                        ...
                        <div class="card bg-primary border-0 position-relative">
                            <div class="card-body">
                                ...
                                <div id="performanceOverview" class="carousel slide performance-overview-carousel position-static pt-2" data-ride="carousel">
                                    ...
                                    <a class="carousel-control-prev" href="dashbord/#performanceOverview" role="button" data-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="sr-only">Previous</span>
                                    </a>
                                    <a class="carousel-control-next" href="dashbord/#performanceOverview" role="button" data-slide="next">
            ...
            <!-- partial:partials/_footer.html -->
                @include('ecommerce.layouts.dashbord.footerdash')
            <!-- partial -->
        </div>
        <!-- main-panel ends -->
...
@section('custom-js')
    ...
    <script src="dashbord/js/dashboard.js"></script>
