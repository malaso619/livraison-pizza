            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" class="cmxform" method="post" id="commentForm" action="{{ route('updated_slider')  }}" enctype="multipart/form-data">
                            <div class="card-body">
                                @if( count($errors)>0 )
                                ...
                                @endif
                                @csrf
                                    <input type="hidden" value="{{ $slide->id_slider }}" name="id_slider">
                                <div class="form-group">
                                    <label for="cname">Titre</label>
                                    <input id="cname" value="{{ $slide->titre }}" class="form-control" name="titre" minlength="2" type="text">
                                </div>
                                <div class="form-group">
                                    <label for="cname">Description</label>
                                    <textarea class="form-control" name="description"  id="" cols="30" rows="13">{{ $slide->description }}</textarea>
